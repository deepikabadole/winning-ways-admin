    ...
    export default {
        ...
        methods: {
            ...
            getUserWorks: function (page = 1) {
                let that = this;
                axios.post(APP_URL+'/get-claimed-works-user/'+that.userId+'?page=' + page,that.filterWorkData).then(response => {
            ...
            getWorks: function (page = 1) {
                let that = this;
                axios.post(APP_URL+'/get-claimed-works?page=' + page, that.filterWorkData).then(response => {
                        that.workData = response.data.res.data;
                        that.workDataPage = response.data.res;
                        that.exportedData = response.data.res.data;
                    }
