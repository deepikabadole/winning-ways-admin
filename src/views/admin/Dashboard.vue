...
<!--    </CRow>-->
      ...
      <CCol lg="12 card">
        ...
        <table class="table table-bordered mt-4" v-if="userData.length">
          ...
          <tr v-for="(wd,index) in userData">
            ...
            <td>{{wd.package}}</td>
            <td>
              <span v-if="wd.expiry">{{wd.expiry | formatTime}}</span>
              <span v-if="!wd.expiry">-</span>
            </td>
            <td>
              <router-link
      ...
      <CCol lg="12 card">
        <CCardHeader>
        <h3 class="mt-3">Recently Posted Works</h3>
        </CCardHeader>
        <CCardBody>
...
export default {
  ...
  methods: {
    ...
    getUsers: function () {
      let that = this;
      axios.get(APP_URL+'/get-recent-users').then(response => {
    ...
    getWorks: function () {
      let that = this;
      axios.get(APP_URL+'/get-recent-works').then(response => {
