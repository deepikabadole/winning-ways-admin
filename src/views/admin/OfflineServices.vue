                ...
                <table class="table table-bordered mt-4" v-if="CategoryData.length">
                    ...
                    <tr v-for="(wd,index) in CategoryData">
                        ...
                        <td>
                            ...
                            <button class="btn btn-success" v-on:click="addCategoryToHomePage(wd.id,2,1)"
                                    v-if="wd.offline_services==0">Add</button>
                            <button class="btn btn-danger" v-on:click="addCategoryToHomePage(wd.id,2,0)"
                                    v-if="wd.offline_services==1">Remove</button>
