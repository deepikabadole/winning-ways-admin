            ...
            <CCol lg="12 card">
                <table class="table table-bordered mt-4" v-if="CategoryData.length">
                    ...
                    <tr v-for="(wd,index) in CategoryData">
                        ...
                        <td>
                            <button class="btn btn-success" v-on:click="addCategoryToHomePage(wd.id,4,1)"
                                    v-if="wd.category_slider2==0">Add to Homepage Slider 2
                            </button>
                            <button class="btn btn-danger" v-on:click="addCategoryToHomePage(wd.id,4,0)"
                                    v-if="wd.category_slider2==1">Remove From Homepage Slider 2
                            </button>
                        </td>
                    </tr>
                    </tbody>
